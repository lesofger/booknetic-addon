(function ($)
{
	...
	$(document).ready(function()
	{
        ...
        $phoneInput.data('iti', window.intlTelInput($phoneInput[0], {
            loadUtilsOnInit: telInputAssetUrl,
            initialCountry: $phoneInput.data('country-code'),
		...
		}).on('click', '#addStaffSave', function ()
		{
            ...
            const phoneNumber = $phoneInput.data('iti').getNumber(intlTelInput.utils.numberFormat.E164);
