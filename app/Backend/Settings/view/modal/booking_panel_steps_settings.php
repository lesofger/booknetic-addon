						...
						<div class="hidden" data-step="date_time">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control" id="input_booking_panel_default_start_month">
                                    ...
                                    <?php $item = 1;
foreach ($parameters['months'] as $month):  ?>
						...
						<div class="hidden" data-step="information">
                            ...
                            <div class="form-group col-md-12">
                                <label for="input_separate_first_and_last_name"><?php echo bkntc__('Identify Customer by')?>:</label>
                                <div class="d-flex mt-2">
                                    <div class="mr-4 cursor-pointer">
                                        <input id="input_customer_identifier_email" type="radio" name="input_customer_identifier" value="email"<?php echo Helper::getOption('customer_identifier', 'email') == 'email' ? ' checked' : ''?>>
                                        <label for="input_customer_identifier_email" class="cursor-pointer"><?php echo bkntc__('Email')?></label>
                                    </div>
                                    <div class="cursor-pointer">
                                        <input id="input_customer_identifier_phone" type="radio" name="input_customer_identifier" value="phone"<?php echo Helper::getOption('customer_identifier', 'email') == 'phone' ? ' checked' : ''?>>
                                        <label for="input_customer_identifier_phone" class="cursor-pointer"><?php echo bkntc__('Phone number')?></label>
                                    </div>
                                </div>
                            </div>
