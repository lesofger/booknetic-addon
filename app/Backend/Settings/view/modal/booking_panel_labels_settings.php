                    ...
                    <div class="booknetic_appointment">
                        <div class="booknetic_appointment_steps">
                            ...
                            <div class="booknetic_appointment_steps_footer">
                                <div class="booknetic_appointment_steps_footer_txt1"><?php echo htmlspecialchars(Helper::getOption('company_phone', '')) == '' ? '' : ('<div class="d-inline-block" data-translate="Have any questions?"></div>')?></div>
                                <div class="booknetic_appointment_steps_footer_txt2"><?php echo htmlspecialchars(Helper::getOption('company_phone', ''))?></div>
                            </div>
                        </div>
    ...
    ?>
                                        <div class="booknetic_service_card">
                                            ...
                                            <div class="booknetic_service_card_description">
                                                <?php echo htmlspecialchars(StringUtil::cutText($serviceInf->notes, 65))?>
                                            </div>
                                        ...
                                        <div class="booknetic_confirm_sum_body<?php echo $parameters['hide_payments'] ? ' booknetic_confirm_sum_body_full_width' : '';?>">
                                            <div class="booknetic_portlet">
                                                ...
                                                <div class="booknetic_confirm_details">
                                                    <div class="booknetic_confirm_details_title"><?php echo isset($serviceInf) ? htmlspecialchars($serviceInf->name) : '???' ?></div>
...
foreach ($parameters['gateways_order'] as $payment_method) {
    ...
    ?>
                                                        <div class="booknetic_payment_method<?php echo !$order_num ? ' booknetic_payment_method_selected' : ''?>">
                                                            ...
                                                            <span data-translate="<?php echo $parameters['payment_gateways'][ $payment_method ]['trnslt']?>"><?php echo htmlspecialchars($parameters['payment_gateways'][ $payment_method ]['title'])?></span>
                                                        </div>
                                                        <?php
    $order_num++;
}
