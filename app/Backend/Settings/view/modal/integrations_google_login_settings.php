			...
			<form class="position-relative">
				...
				<div class="form-row enable_disable_row">
					...
					<div class="form-group col-md-2">
						...
						<label for="input_google_login_enable"><?php echo bkntc__('Disabled')?></label>
					</div>
					<div class="form-group col-md-2">
						...
						<label for="input_google_login_disable"><?php echo bkntc__('Enabled')?></label>
					</div>
				...
				<div id="integrations_google_login_settings_area">
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="input_google_login_app_id"><?php echo bkntc__('App ID')?>: <span class="required-star">*</span></label>
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="input_google_login_app_secret"><?php echo bkntc__('App Secret')?>: <span class="required-star">*</span></label>
