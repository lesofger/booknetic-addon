            ...
            const modalContent =
                `<div class="">
                    ...
                    <div class="p-3 modal-content">
                       <div class="d-flex">
                        ...
                        <div class="mt-3 d-none download-font">
                            <button class="btn btn-success btn-sm download-font-btn">${booknetic.__('Download font')}</button>
                        </div>
                    ...
                    <footer class="modal-footer d-flex justify-content-end align-items-center p-3">
                        <button data-dismiss="modal" class="btn btn-primary btn-lg">${booknetic.__("Cancel")}</button>
                        <button data-dismiss="modal" class="btn btn-success btn-lg">${booknetic.__("Save")}</button>            
                    </footer>
                 </div>`;
