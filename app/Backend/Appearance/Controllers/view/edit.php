...
/**
 * @var AppearanceResponse $parameters
 */
?>

<script type="application/javascript" src="<?php echo Helper::assets('js/vanilla-picker.min.js', 'Appearance')?>"></script>
<script src="<?php echo Helper::assets('js/edit.js', 'Appearance')?>" id="appearance-script" data-id="<?php echo $parameters->getId();?>"></script>
...
<link rel="stylesheet" href="<?php echo $parameters->getCssFile()?>" type="text/css">
		...
		<div class="fs_portlet fs_portlet_with_footer">
			...
			<div class="fs_portlet_content">
				...
				<div class="f_option_element">
					...
					<span class="f_option_val">
						<div class="inner-addon right-addon">
							<input value="<?php echo htmlspecialchars($parameters->getName())?>" id="input_name" class="form-control" placeholder="<?php echo bkntc__('Type name...')?>" maxlength="100">
				...
				<div class="f_option_element">
					...
					<span class="f_option_val">
						<input value="<?php echo (int)$parameters->getHeight()?>" id="input_height" class="form-control text-right" maxlength="100">
				...
				<div class="f_option_element font_family_element">
					...
					<div class="f_option_val">
                        <select id="select-font-family" class="form-control">
							<?php if (!empty($parameters->getFontFamily())): ?>
								<option value="<?php echo htmlspecialchars($parameters->getFontFamily())?>" selected><?php echo htmlspecialchars($parameters->getFontFamily())?></option>
							<?php endif ?>
						</select>
                        <button class="btn btn-secondary btn-sm px-2" id="open_font_settings">
                            <i class="fa fa-cog" aria-hidden="true"></i>
                        </button>
					</div>
					<input id="use_local_font" type="checkbox" class="d-none" <?php if ($parameters->getUseLocalFont() == '1') {
					    echo 'checked';
					} ?>/>
				</div>
				...
				<div class="f_option_element">
					...
					<span class="f_option_val">
						<div class="colorpicker01" data-for="panel" data-color="<?php echo $parameters->getColors()['panel']?>"><i class="fa fa-caret-down"></i></div>
					</span>
				</div>
				...
				<div class="f_option_element">
					...
					<span class="f_option_val">
						<div class="colorpicker01" data-for="primary" data-color="<?php echo $parameters->getColors()['primary']?>"><i class="fa fa-caret-down"></i></div>
						<div class="colorpicker01" data-for="primary_txt" data-color="<?php echo $parameters->getColors()['primary_txt']?>"><i class="fa fa-caret-down"></i></div>
					</span>
				</div>
				...
				<div class="f_option_element">
					...
					<span class="f_option_val">
						<div class="colorpicker01" data-for="compleated_steps" data-color="<?php echo $parameters->getColors()['compleated_steps']?>"><i class="fa fa-caret-down"></i></div>
						<div class="colorpicker01" data-for="compleated_steps_txt" data-color="<?php echo $parameters->getColors()['compleated_steps_txt']?>"><i class="fa fa-caret-down"></i></div>
					</span>
				</div>
				...
				<div class="f_option_element">
					...
					<span class="f_option_val">
						<div class="colorpicker01" data-for="active_steps" data-color="<?php echo $parameters->getColors()['active_steps']?>"><i class="fa fa-caret-down"></i></div>
						<div class="colorpicker01" data-for="active_steps_txt" data-color="<?php echo $parameters->getColors()['active_steps_txt']?>"><i class="fa fa-caret-down"></i></div>
					</span>
				</div>
				...
				<div class="f_option_element">
					...
					<span class="f_option_val">
						<div class="colorpicker01" data-for="other_steps" data-color="<?php echo $parameters->getColors()['other_steps']?>"><i class="fa fa-caret-down"></i></div>
						<div class="colorpicker01" data-for="other_steps_txt" data-color="<?php echo $parameters->getColors()['other_steps_txt']?>"><i class="fa fa-caret-down"></i></div>
					</span>
				</div>
				...
				<div class="f_option_element">
					...
					<span class="f_option_val">
						<div class="colorpicker01" data-for="title" data-color="<?php echo $parameters->getColors()['title']?>"><i class="fa fa-caret-down"></i></div>
					</span>
				</div>
				...
				<div class="f_option_element">
					...
					<span class="f_option_val">
						<div class="colorpicker01" data-for="border" data-color="<?php echo $parameters->getColors()['border']?>"><i class="fa fa-caret-down"></i></div>
					</span>
				</div>
                ...
                <div class="f_option_element">
                    ...
                    <span class="f_option_val">
						<div class="colorpicker01" data-for="price" data-color="<?php echo $parameters->getColors()['price']?>"><i class="fa fa-caret-down"></i></div>
					</span>
                </div>

                <div class="f_option_element">
                    <span class="f_option_name"><?php echo bkntc__('Hide steps')?></span>
                    <input id="hide_steps" type="checkbox" <?php if ($parameters->getHideSteps() === '1') {
                        echo 'checked';
                    } ?>/>
                </div>
                ...
                <div class="f_option_element f_option_element_custom_css_textarea">
                    <div>
                        <textarea name="custom_css" id="custom_css"><?php echo htmlspecialchars($parameters->getCustomCss()); ?></textarea>
                    </div>
                </div>
			...
			<div class="fs_portlet_footer">
                ...
                <div>
                    <div>
                        <?php if ($parameters->getId() > 0) : ?>
                            <div class="theme_id_cls"><?php echo bkntc__('Theme ID: %d', [$parameters->getId()])?></div>
                        <?php endif; ?>
                    </div>
                </div>
			</div>
		...
		<div class="fs_portlet">
			...
			<div class="fs_portlet_content">
				...
				<div id="booknetic_panel_area">
					<div class="booknetic_appointment" id="booknetic_theme_<?php echo $parameters->getId()?>">
