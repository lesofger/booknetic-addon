...
class Config
{
    ...
    public static function registerCoreRoutes(): void
    {
        ...
        if (Capabilities::tenantCan('customers')) {
            Route::get('customers', Backend\Customers\Controllers\CustomerController::class);
            Route::post('customers', Backend\Customers\Controllers\CustomerAjaxController::class);
        }
    ...
    public static function registerSigningPage(): void
    {
        ...
        if (!empty($sign_in_page) && ($sign_in_page_link = get_permalink($sign_in_page)) && !empty($sign_in_page_link)) {
            add_filter('login_url', static function ($login_url, $redirect) use ($sign_in_page_link) {
                if (! empty($redirect)) {
    ...
    {
        Container::addTransient(FSCodeAPIClient::class, [new FSCodeAPIClientFactory(), 'make']);
        Container::add(PluginService::class);
        Container::add(FSCodeApiService::class);
    }
